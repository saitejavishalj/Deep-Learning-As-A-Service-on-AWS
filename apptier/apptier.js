...
async function uploadToOutS3(InputFile,predictedOutput){
    ...
    BUCKET_NAME ="output-group-cloud-computing"
...
async function downloadfromS3(currentFile){
  return new Promise((resolve, reject) => {
    var params = {Bucket: 'input-group-cloud-computing', Key : currentFile}
...
MessageBody: InputFile,
// MessageGroupId:"test-group-input",
...
let file= await downloadfromS3(currentFile).then(data=>{
  return data;
})
